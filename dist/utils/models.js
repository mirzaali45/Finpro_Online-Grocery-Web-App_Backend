 ...
 */
var checkProductAvailability = function (productId, quantity) { return __awaiter(void 0, void 0, void 0, function () {
    var inventories, totalStock;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prisma.inventory.findMany({
            ...
            case 1:
                ...
                if (totalStock < quantity) {
                    throw new Error("Stok produk dengan ID ".concat(productId, " tidak mencukupi. (required: ").concat(quantity, ", available: ").concat(totalStock, ")"));
                }
