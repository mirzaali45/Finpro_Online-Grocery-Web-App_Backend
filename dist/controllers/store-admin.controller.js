...
var StoreAdminController = /** @class */ (function () {
    function StoreAdminController() {
    }
    // View-only Product Management
    StoreAdminController.prototype.getProducts = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var store, products, error_1, message;
            var _a;
    ...
    StoreAdminController.prototype.getProductById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var product_id, store, product, error_2, message;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
